...
import undraw from "@/public/light.jpg"
...
const ProjectDetailsPage = ({ props }: any) => {
  ...
  React.useEffect(() => {
    const calls = async () => {
      ...
      fetch("https://eco-seeds.vercel.app/api/sales?sale=" + id)
        .then((res) => res.json())
        .then((data) => {
          setTokenContract(data.data.contract)

          const info = fetch(
            "https://eco-seeds.vercel.app/api/contractdata?contract=" +
              data.data.contract
          )
            .then((res) => res.json())
            .then((data) => {
              ...
              const date = convertTimestamp(
                parseInt(BigInt(data.data[4].hex).toString())
              )
              setLockFinish(date)
              setIsLoaded(true)
            })
            ...
            <CardContent className={cn("flex w-1/2 flex-col space-y-10 p-6")}>
              <div className="grid grid-cols-6 gap-2">
                ...
                <div className="col-span-5 space-y-2">
                  <CardTitle>EcoSeeds Launch</CardTitle>
                  <CardDescription className="text-md">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                    Unde sit possimus quam? Facere, ipsum! Facilis fuga
                    quisquam, impedit repellat eos atque libero tenetur nihil
                    neque voluptates consectetur facere exercitationem
                    architecto!
                  </CardDescription>
                  <CardDescription className="text-md">
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Please confirm how much you want to invest to the
                        project
                      </DialogDescription>
                    </DialogHeader>
                    <Form {...form}>
            ...
            <CardContent className={cn("w-1/2 p-6")}>
              <div className="grid grid-cols-2 gap-6 rounded-md bg-[#B3C6AD] p-6 dark:bg-green-900">
                <div className="space-y-1 rounded-md bg-background p-4">
                  ...
                  <p className="font-bold">
                    {ethers.utils.formatEther(
                      BigInt(saleData[5].hex).toString()
                    )}
                  </p>
                </div>
                <div className="space-y-1 rounded-md bg-background p-4">
                ...
                <div className="space-y-1 rounded-md bg-background p-4">
                  ...
                  <p className="font-bold">
                    {BigInt(saleData[6].hex).toString()}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardHeader>
              <div className="flex flex-row items-center space-x-1">
                ...
                <div className="flex w-full flex-row items-center justify-between">
                  ...
                  <h3>
                    {ethers.utils.formatEther(
                      BigInt(saleData[3].hex).toString()
                    )}{" "}
                    CELO
                  </h3>
                </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <Card className="col-span-2 p-6">
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
              ...
              inventore facilis temporibus? Maiores numquam aliquid temporibus
              a. Eligendi commodi id harum dicta. The king thought long and
              hard, and finally came up with{" "}
              <a
                href="#"
          ...
          <Card className="col-span-2 col-start-2 p-6">
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
              ...
              kings foolishness get him down: a court jester named Jokester.
            </p>
          </Card>
          <Card className="col-span-2 col-start-2 p-6">
            <h2 className="scroll-m-20 border-b border-[#B3C6AD] pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0">
